                                ...
                                <div class="prod-spec-box">
                                    ...
                                    <div class="prod-buy-box">
                                        ...
                                        <div class="prod-buy">
                                            ...
                                            <asp:Button ID="bAddProduct" CssClass="prod-buy-button" CommandName="addToBasket" CommandArgument='<%# Eval("id") %>' runat="server" PostBackUrl="~/MainForm.aspx" Text="Dodaj do koszyka" />
                                        </div>
                                    </div>
                                </div>
                            </div>
